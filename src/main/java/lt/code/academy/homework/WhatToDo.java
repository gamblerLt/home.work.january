...
public class WhatToDo {
    ...
    *
    * - privalo buti dependencies
    *
    * - privalo buti maven
    *  - privalo buti jason - 37 paskaita video irasymas i json
    *
    * - vartotojo prisijungimas
    *
    * - testo pasirinkimas - meniu
    *
    *  - validacija ????
    *
    * - vaikiniuose pom (jeigu tokiu bus) dependencies versiju nereikia
    *
    * what the heck konsole
    *
    * -----------------------------------------------------------------
...
Programos supakavimui panaudoti Maven
...
Optional:
- Panaudoti Generics
- programą turi būti galima paleisti naudojant komandinę eilutę
